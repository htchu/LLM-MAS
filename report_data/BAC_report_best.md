...
**Model File:** `BAC_rl_model_best.zip`
...
|--------|------------------------------|------------|
| Annualized Return | 44.12% | 22.64% |
| Sharpe Ratio | 1.644 | 0.844 |
| Maximum Drawdown | -14.23% | -28.01% |
| Conditional VaR (95%) | -3.20% | -4.53% |
| Annualized Volatility | 24.01% | 29.30% |
| Win Rate | 70.00% | N/A |
| Total Trades | 31 | 1 |
| Final Portfolio Net Worth | 1,356,007.50 USD | 1,185,370.79 USD |
| Initial Capital | 1,000,000.00 USD | 1,000,000.00 USD |

## Trade Records and Charts
* **Detailed Trade Log:** See `BAC_trades_best.csv` (strategy only)
* **Interactive Trading Chart:** See `BAC_trading_chart_best.html` (open with browser, includes Buy&Hold comparison)
...
*Report generated on 2025-09-07 10:15:19*

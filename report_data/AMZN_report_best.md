...
**Model File:** `AMZN_rl_model_best.zip`

## Data Periods
* **Training Data:** 2000-10-16 to 2021-12-31
* **Validation Data:** 2022-01-01 to 2024-06-30
...
|--------|------------------------------|------------|
| Annualized Return | 65.30% | 30.72% |
| Sharpe Ratio | 2.392 | 0.944 |
| Maximum Drawdown | -7.83% | -30.88% |
| Conditional VaR (95%) | -2.59% | -4.50% |
| Annualized Volatility | 22.03% | 34.69% |
| Win Rate | 100.00% | N/A |
| Total Trades | 6 | 1 |
| Final Portfolio Net Worth | 1,520,183.71 USD | 1,250,085.47 USD |
| Initial Capital | 1,000,000.00 USD | 1,000,000.00 USD |

## Trade Records and Charts
* **Detailed Trade Log:** See `AMZN_trades_best.csv` (strategy only)
* **Interactive Trading Chart:** See `AMZN_trading_chart_best.html` (open with browser, includes Buy&Hold comparison)
...
*Report generated on 2025-09-02 23:04:35*

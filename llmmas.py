...
class TradingConfig:
    ...
    STOCK_TICKER = "AAPL"  # Apple
    # Alternative options: "AAPL" (Apple), "AMZN" (Amazon), "MSFT" (Microsoft), "TSLA" (Tesla), "GOOG" (Alphabet)
    ...
    WINDOW_SIZE = 55  # RL environment observation window size
    ...
    def get_sb3_log_dir(cls):
        return os.path.join(cls.DATA_DIR, "sb3_logs")
    
    @classmethod
    def get_optuna_db_path(cls):
        return os.path.join(cls.DATA_DIR, "optuna_study.db")
    ...
    MIN_TRADE_SHARES = 1         # Minimum trade size for US stocks
    
    # Risk management configuration
    PROFIT_REWARD_FACTOR = 0.035      # Profit reward factor 0.025 
    VOLATILITY_PENALTY_FACTOR = 0.01  # Volatility penalty factor 0.003
    STOP_LOSS_PCT = 0.05              # Stop loss at 5%
    TAKE_PROFIT_PCT = 0.5             # Take profit at 50%
    MAX_POSITION_RISK_PCT = 0.015     # Maximum position risk percentage 0.025
    ATR_PERIOD_FOR_SIZING = 21        # ATR period for position sizing
...
* **Backtest (Validation) Data:** {test_period[0]} to {test_period[1]}
